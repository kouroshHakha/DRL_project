...
class NgSpiceWrapper(object):
    ...
    BASE_TMP_DIR = os.path.abspath("/tmp/"+os.environ['USER']+"/circuit_drl"+str(os.getpid()))
    ...
    def run(self, states, verbose=False):
        ...
        specs = self.pool.starmap(self.create_design_and_simulate, arg_list)
        return specs
